...
final _monthDayFormat = DateFormat('dd MMM yyyy');
...
class _StatisticsScreenState extends State<StatisticsScreen> {
  ...
  int totalLongBreaksCompleted = 0;
  int totalShortBreaksCompleted = 0;
  int totalWorkSessionsFailed = 0;
  int totalLongBreaksFailed = 0;
  int totalShortBreaksFailed = 0;
